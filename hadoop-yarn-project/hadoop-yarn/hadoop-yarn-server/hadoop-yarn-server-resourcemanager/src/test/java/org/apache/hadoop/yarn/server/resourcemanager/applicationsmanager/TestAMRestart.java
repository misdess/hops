...
public class TestAMRestart {
  ...
  public void testAMRestartWithExistingContainers() throws Exception {
    ...
    try {
      ...
      Assert.assertEquals(containerId6,
          schedulerAttempt.getReservedContainers().get(0).getContainerId());
      ...
      System.out.println("HOP :: TestAMRestart - check 1");
      // launch the new AM
      ...
      Assert.assertTrue(
          container3Exists && container4Exists && container5Exists &&
              container6Exists);
  ...
  public void testNMTokensRebindOnAMRestart() throws Exception {
    ...
    try {
      rm1.start();
      RMApp app1 = rm1.submitApp(200, "myname", "myuser",
          new HashMap<ApplicationAccessType, String>(), false, "default", -1,
          null, "MAPREDUCE", false, true);
      MockNM nm1 =
      ...
      nm1.nodeHeartbeat(am2.getApplicationAttemptId(), 2,
          ContainerState.RUNNING);
      ...
      // fail am2.
      nm1.nodeHeartbeat(am2.getApplicationAttemptId(), 1,
          ContainerState.COMPLETE);
      ...
      List<NMToken> transferredTokens =
          registerResponse.getNMTokensFromPreviousAttempts();
